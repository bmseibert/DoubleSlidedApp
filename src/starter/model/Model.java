...
public class Model {
	...
	public NumberedTile[] pieces = new NumberedTile[8];
	public EmptyTile space;
	
	public Model(NumberedTile[] pieces, EmptyTile space) 
	{
		pieces[0] = new NumberedTile(3, 2, false);
		pieces[1] = new NumberedTile(2, 3, false);
		pieces[2] = new NumberedTile(1, 4, false);
		pieces[3] = new NumberedTile(4, 1, false);
		pieces[4] = new NumberedTile(2, 3, true);
		pieces[5] = new NumberedTile(1, 4, true);
		pieces[6] = new NumberedTile(4, 1, true);
		pieces[7] = new NumberedTile(3, 2, true);
...
//		space.setLocation(new Cell(2,2));
		this.pieces = pieces;
		this.space = space;
	}
